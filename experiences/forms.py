...
class ExperienceForms(forms.ModelForm):
    ...
    company = forms.CharField(
        label="Company Name", widget=forms.TextInput(attrs={"placeholder": "Google"})
    )
    city = forms.CharField(
        label="City", widget=forms.TextInput(attrs={"placeholder": "Mountain View"})
    )
...
ExperienceDescriptionFormSet = modelformset_factory(
    ExperienceDescription,
    form=ExperienceDescriptionForms,
    fields=("description",),
    extra=1,
)
